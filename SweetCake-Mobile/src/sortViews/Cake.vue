<template>
	<div>
		<div class="pro-list">
			<div class="pro-item" v-for="item in cakeList">
				...
				<div class="pro-bottom">
					...
					<img src="https://static.21cake.com//themes/wap/img/list-cart.png" alt="" @click="addToCart(item.id,item.pro_name,item)">
				</div>
	...
	export default {
		...
		mounted(){
			...
			.then((res)=>{
				...
				this.cakeList = res.data.map(data=>{
					data.isShow=false;
					return data;
				});
